...
//$min_serveOptions['minifierOptions']['text/css']['current'] = "http://".$_SERVER["HTTP_HOST"].DIRECTORY_SEPARATOR;
...
$min_symlinks = array('/var/www/accounts/'.$domain => '/var/www/accounts/demo');

/**
 * If you upload files from Windows to a non-Windows server, Windows may reports

 ...
 * Class cnt_events
 */
class cnt_events extends cls_controllerlist {

    /**
     * cnt_events constructor.
     */
    public function __construct() {
        $this->model = m_events::get_instance();
        //parent::__construct();
    }
    ...
    public function get_info() {
        ...
        $result = array();
        $result["meta_title"]   = L::modules_events_name;
        $result["ar_sort"]      = $this->model->ar_sort;
        $result["total"]        = $this->total;
        $result["module"] = array("morph"=> array(L::modules_events_morph_one, L::modules_events_morph_two, L::modules_events_morph_five));

        $action_search = array("name"=>L::text_setup, "icon"=>"search", "href"=>"events/tuning/", "modal"=>true);

 ...
 * Class cnt_mrooms
 */
class cnt_mrooms extends cls_controllerlist {
     ...
     */
        ...
        $result["actions"][] = array("name"=>L::actions_reserved, "icon"=>"clock-o", "href"=>"mrooms/reservations/create/", /*"modal"=>true,*/ "type"=>"primary");
        ...
        $center__childOptions["east"]["childOptions"]["south"] = array("size"=>'60%'/*, "spacing_open"=>0*/);

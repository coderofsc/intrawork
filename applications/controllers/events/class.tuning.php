...
/**
 * Class cnt_events_tuning
 */
class cnt_events_tuning extends cls_controller {
    ...
    public function get_info() {
        $result = array();
        $result["meta_title"] = L::modules_events_tuning_name;

        $result["path"][] = array("title"=>L::modules_events_name, "url"=>"events/");

        return $result;
    }

    /**
     * cnt_events_tuning constructor.
     */
    ...
    {
        $this->user_request["conditions"]	= (isset($_REQUEST["cnd"]))?m_events::get_instance()->clear_conditions($_REQUEST["cnd"]):array();
    ...
    {
        return cls_register::get_instance()->smarty->fetch("events/tuning.tpl");
    }
    ...
    public function process()
    {
        ...
        $c_events = new cnt_events();
        $cnd_users_info = $c_events->get_info();

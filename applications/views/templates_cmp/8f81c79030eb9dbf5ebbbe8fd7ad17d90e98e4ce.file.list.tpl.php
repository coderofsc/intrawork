<?php /* Smarty version Smarty-3.1.21-dev, created on 2019-02-06 03:25:51
         compiled from "W:\home\intrawork.loc\demo\applications\views\templates\mailbots\list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:204265c5a298f190223-39361717%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8f81c79030eb9dbf5ebbbe8fd7ad17d90e98e4ce' => 
    array (
      0 => 'W:\\home\\intrawork.loc\\demo\\applications\\views\\templates\\mailbots\\list.tpl',
      1 => 1450952362,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '204265c5a298f190223-39361717',
  'function' => 
  array (
    'get_name' => 
    array (
  ...
  'unifunc' => 'content_5c5a298f408fb7_54154965',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c5a298f408fb7_54154965')) {function content_5c5a298f408fb7_54154965($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'c:\\WebServers\\home\\intrawork.loc\\app\\classes\\smarty\\plugins\\modifier.replace.php';
...
-table" class="table table-valign-middle table-condensed table-hover clamped-margin-bottom table-sticky-head footable">
    ...
    <tr>
        ...
        <th data-hide="phone"><?php echo L::forms_labels_mailbots_address;?>
</th>
        <th data-hide="all"><?php echo smarty_modifier_mb_ucfirst(L::modules_demands_types_morph_one);?>
</th>
        <th data-hide="all"><?php echo smarty_modifier_mb_ucfirst(L::modules_categories_morph_one);?>
</th>
        <th data-hide="phone"><?php echo L::forms_labels_mailbots_server;?>
</th>
        <th data-name="<?php echo L::forms_labels_mailbots_in;?>
" class="text-center"><i class="fa fa-sign-in"></i></th>
        <th data-name="<?php echo L::forms_labels_mailbots_out;?>
" class="text-center"><i class="fa fa-sign-out"></i></th>
...
">
        <td></td>
        <td>
            <i class="fa fa-toggle-<?php if ($_smarty_tpl->tpl_vars['item']->value['status']) {?>on<?php } else { ?>off<?php }?>"></i>
        </td>
        <td>
        ...
        <td>
            <label class="label label-<?php echo $_smarty_tpl->tpl_vars['item']->value['type_type'];?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("helpers/catpath.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>$_smarty_tpl->tpl_vars['item']->value['cat_id']), 0, '204265c5a298f190223-39361717');
content_5c5a298f2c4be9_26900340($_smarty_tpl);
...
echo L::text_inbox;
        ...
        <td class="text-center">
            <span class="badge badge-white"><?php echo $_smarty_tpl->tpl_vars['item']->value['count_in'];?>
</span>
        </td>
        <td class="text-center">
            <span class="badge badge-white"><?php echo $_smarty_tpl->tpl_vars['item']->value['count_out'];?>
</span>
        </td>
        <td class="text-right">
            <?php /*  Call merged included template "helpers/lists/actions.tpl" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("helpers/lists/actions.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('module_id'=>$_smarty_tpl->tpl_vars['module_id']->value,'id'=>$_smarty_tpl->tpl_vars['item_id']->value), 0, '204265c5a298f190223-39361717');
content_5c5a298f31aaf4_09468643($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php if ($_valid && !is_callable('content_5c5a298f2c4be9_26900340')) {function content_5c5a298f2c4be9_26900340($_smarty_tpl) {?><?php if (!function_exists('smarty_template_function_get_name')) {
...
<?php if ($_valid && !is_callable('content_5c5a298f31aaf4_09468643')) {function content_5c5a298f31aaf4_09468643($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'c:\\WebServers\\home\\intrawork.loc\\app\\classes\\smarty\\plugins\\modifier.replace.php';

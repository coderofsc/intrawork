<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-09-22 14:34:49
         compiled from "Z:\home\intrawork.loc\demo\applications\views\templates\helpers\forms\cat_options.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2152059c4f5597c7ea2-60972125%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '970accec10e2bfb55c989295201a6f33453f1563' => 
    array (
      0 => 'Z:\\home\\intrawork.loc\\demo\\applications\\views\\templates\\helpers\\forms\\cat_options.tpl',
      1 => 1450362482,
      2 => 'file',
    ),
    '26fa56600e7507ef90b00ee2a3676e54e40333c1' => 
    array (
      0 => 'Z:\\home\\intrawork.loc\\demo\\applications\\views\\templates\\helpers\\abstracts\\tree_options.tpl',
      1 => 1449567882,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2152059c4f5597c7ea2-60972125',
  'function' => 
  array (
    'menu' => 
    array (
  ...
  'unifunc' => 'content_59c4f559999108_08367875',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c4f559999108_08367875')) {function content_59c4f559999108_08367875($_smarty_tpl) {?><?php if (!isset($_smarty_tpl->tpl_vars['selected']->value)) {?>
...
<option <?php if ($_smarty_tpl->tpl_vars['item']->value['visible_only']||($_smarty_tpl->tpl_vars['crud']->value&&!($_smarty_tpl->tpl_vars['cuser_data']->value['crud_categories'][$_smarty_tpl->tpl_vars['key']->value]&m_roles::CRUD_C))) {?>disabled=""<?php }?> data-content="<i class='fa sp-icon fa-fw <?php if ($_smarty_tpl->tpl_vars['item']->value['icon']) {
echo $_smarty_tpl->tpl_vars['item']->value['icon'];
} else { ?>fa-circle<?php }?>' style='color: <?php if ($_smarty_tpl->tpl_vars['item']->value['bgcolor']) {
echo $_smarty_tpl->tpl_vars['item']->value['bgcolor'];
} elseif ($_smarty_tpl->tpl_vars['item']->value['icon']) {?>#a7b1c2<?php } else { ?>#e7e7e7<?php }?>'></i><?php echo htmlspecialchars(Smarty::$_smarty_vars['capture']['label']);
...
" <?php if ($_smarty_tpl->tpl_vars['only']->value&&((is_array($_smarty_tpl->tpl_vars['only']->value)&&!in_array($_smarty_tpl->tpl_vars['key']->value,$_smarty_tpl->tpl_vars['only']->value))||(!is_array($_smarty_tpl->tpl_vars['only']->value)&&$_smarty_tpl->tpl_vars['only']->value!=$_smarty_tpl->tpl_vars['key']->value))) {?>disabled<?php }?> <?php if ($_smarty_tpl->tpl_vars['selected']->value==$_smarty_tpl->tpl_vars['key']->value||(is_array($_smarty_tpl->tpl_vars['selected']->value)&&in_array($_smarty_tpl->tpl_vars['key']->value,$_smarty_tpl->tpl_vars['selected']->value))) {?>selected=""<?php }?>>
    <?php echo Smarty::$_smarty_vars['capture']['label'];?>

</option>
<?php if ($_smarty_tpl->tpl_vars['key']->value==0) {?><option data-divider="true"></option><?php }?>

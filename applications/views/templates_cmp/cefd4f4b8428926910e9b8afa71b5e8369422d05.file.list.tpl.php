<?php /* Smarty version Smarty-3.1.21-dev, created on 2019-02-06 03:30:49
         compiled from "W:\home\intrawork.loc\demo\applications\views\templates\mrooms\list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:300905c5a2ab9b83543-29513973%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cefd4f4b8428926910e9b8afa71b5e8369422d05' => 
    array (
      0 => 'W:\\home\\intrawork.loc\\demo\\applications\\views\\templates\\mrooms\\list.tpl',
      1 => 1450362482,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '300905c5a2ab9b83543-29513973',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c5a2ab9d9a839_23342263',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c5a2ab9d9a839_23342263')) {function content_5c5a2ab9d9a839_23342263($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'c:\\WebServers\\home\\intrawork.loc\\app\\classes\\smarty\\plugins\\modifier.replace.php';
?>
...
-table" class="table table-valign-middle table-condensed table-hover clamped-margin-bottom table-sticky-head footable">
    ...
    <tr>
        <th></th>
        <th></th>
        <th title="<?php echo L::forms_labels_mrooms_projector;?>
" class="text-center"><i class="fa fa-play"></i></th>
        <th title="<?php echo L::forms_labels_mrooms_loudspeaker;?>
" class="text-center"><i class="fa fa-volume-up"></i></th>
        <th title="<?php echo L::forms_labels_mrooms_microphone;?>
" class="text-center"><i class="fa fa-microphone"></i></th>
        <th title="<?php echo L::forms_labels_mrooms_whiteboard;?>
" class="text-center"><i class="fa fa-pencil"></i></th>
        <th title="<?php echo L::forms_labels_mrooms_conference;?>
" class="text-center"><i class="fa fa-users"></i></th>
        <th></th>
    </tr>
    </thead>
...
">
        <td>
            <div style="height:24px; width:24px; background-color: <?php echo $_smarty_tpl->tpl_vars['item']->value['bgcolor'];?>
"></div>
        </td>
        <td>
        ...
        <?php if ($_smarty_tpl->tpl_vars['item']->value['rflags']&@constant('RM_PROJECTOR')) {?><td class="text-center text-success"><i class="fa fa-check"></i></td><?php } else { ?><td class="text-center text-muted"><i class="fa fa-times"></i></td><?php }?>
        <?php if ($_smarty_tpl->tpl_vars['item']->value['rflags']&@constant('RM_LOUDSPEAKER')) {?><td class="text-center text-success"><i class="fa fa-check"></i></td><?php } else { ?><td class="text-center text-muted"><i class="fa fa-times"></i></td><?php }?>
        <?php if ($_smarty_tpl->tpl_vars['item']->value['rflags']&@constant('RM_MICROPHONE')) {?><td class="text-center text-success"><i class="fa fa-check"></i></td><?php } else { ?><td class="text-center text-muted"><i class="fa fa-times"></i></td><?php }?>
        <?php if ($_smarty_tpl->tpl_vars['item']->value['rflags']&@constant('RM_WHITEBOARD')) {?><td class="text-center text-success"><i class="fa fa-check"></i></td><?php } else { ?><td class="text-center text-muted"><i class="fa fa-times"></i></td><?php }?>
        <?php if ($_smarty_tpl->tpl_vars['item']->value['rflags']&@constant('RM_CONFERENCE')) {?><td class="text-center text-success"><i class="fa fa-check"></i></td><?php } else { ?><td class="text-center text-muted"><i class="fa fa-times"></i></td><?php }?>
        <td class="text-right">
            <?php /*  Call merged included template "helpers/lists/actions.tpl" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("helpers/lists/actions.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('module_id'=>$_smarty_tpl->tpl_vars['module_id']->value,'id'=>$_smarty_tpl->tpl_vars['item_id']->value), 0, '300905c5a2ab9b83543-29513973');
content_5c5a2ab9cb7f00_52447379($_smarty_tpl);
...
<?php if ($_valid && !is_callable('content_5c5a2ab9cb7f00_52447379')) {function content_5c5a2ab9cb7f00_52447379($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'c:\\WebServers\\home\\intrawork.loc\\app\\classes\\smarty\\plugins\\modifier.replace.php';
